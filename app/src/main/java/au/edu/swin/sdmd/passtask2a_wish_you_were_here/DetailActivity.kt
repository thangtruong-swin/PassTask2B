...
//            Find TextView components and display values on them
            val vTitle = findViewById<TextInputEditText>(R.id.TextEditTitle)
            vTitle.setText(it.title)
            val vCity = findViewById<TextInputEditText>(R.id.TextEditCity)
...
//          Find TextView components and display values on them
            vDate = findViewById<TextInputEditText>(R.id.TextEditDate)
    ...
    override fun onBackPressed() {
        val vTitle2 = findViewById<TextInputEditText>(R.id.TextEditTitle)
        //        Assigned equal true when visited
        location?.visited = true
        val i = intent.apply {
            location?.title = vTitle2?.text.toString()
